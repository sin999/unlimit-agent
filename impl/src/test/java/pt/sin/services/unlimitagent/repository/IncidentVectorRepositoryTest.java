...
class IncidentVectorRepositoryTest {
    ...
    private IncidentVectorRepository build() {
        return new IncidentVectorRepository(resourceLoader, vectorStore);
    }
    ...
    void returnsRelevantPastIncidents() {
        ...
        String result = build().findSimilarIncidents("card payments failing");
    ...
    void fallback_whenNoResults() {
        ...
        String result = build().findSimilarIncidents("something obscure");
